function varargout = CAPTURE_5(varargin)
% CAPTURE_5 MATLAB code for CAPTURE_5.fig
%   imaqhwinfo
%   VidObj= videoinput('winvideo',1, 'RGB24_320x240');
%   imaqhwinfo(VidObj)
%  See also: GUIDE, GUIDATA, GUIHANDLES

% Edit the above text to modify the response to help CAPTURE_5

% Last Modified by GUIDE v2.5 15-Feb-2020 21:22:15

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @CAPTURE_5_OpeningFcn, ...
                   'gui_OutputFcn',  @CAPTURE_5_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before CAPTURE_5 is made visible.
function CAPTURE_5_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to CAPTURE_5 (see VARARGIN)
set(handles.PRW,'Visible','off')
% Choose default command line output for CAPTURE_5
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes CAPTURE_5 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = CAPTURE_5_OutputFcn(hObject, eventdata, handles) 
